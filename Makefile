...
LDFLAGS := -s -w \
	-X 'github.com/yourname/minibox/internal/core/version.Tag=$(VERSION)' \
	-X 'github.com/yourname/minibox/internal/core/version.Commit=$(COMMIT)' \
	-X 'github.com/yourname/minibox/internal/core/version.Date=$(DATE)'
