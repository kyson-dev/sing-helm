...
LDFLAGS := -s -w \
	-X 'github.com/kyson-dev/sing-helm/internal/sys/version.Tag=$(VERSION)' \
	-X 'github.com/kyson-dev/sing-helm/internal/sys/version.Commit=$(COMMIT)' \
	-X 'github.com/kyson-dev/sing-helm/internal/sys/version.Date=$(DATE)'
