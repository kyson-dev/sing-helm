...
LDFLAGS := -s -w \
	-X 'github.com/kyson-dev/sing-helm/internal/version.Tag=$(VERSION)' \
	-X 'github.com/kyson-dev/sing-helm/internal/version.Commit=$(COMMIT)' \
	-X 'github.com/kyson-dev/sing-helm/internal/version.Date=$(DATE)'
